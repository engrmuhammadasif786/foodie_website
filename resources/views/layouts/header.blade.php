				...
				<div class="col-7 header-right">
					<div class="d-flex align-items-center justify-content-end pr-5">
						...
						<a href="{{url('offers')}}" class="widget-header mr-4 text-dark offer-link">
							<div class="icon d-flex align-items-center">
								<!-- <i class="feather-disc h6 mr-2 mb-0"></i> --><img alt="#" class="img-fluid mr-2" src="{{asset('img/discount.png')}}"> <span>{{trans('lang.offers')}}</span>
							</div>
						</a>
						@auth
						...
						<div class="dropdown mr-4 m-none">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
								@auth
								  	...
								  	<a class="dropdown-item" href="{{url('restaurants')}}">{{trans('lang.all_restaurants')}}</a>
								  	<a class="dropdown-item dine_in_menu" style="display: none;" href="{{url('restaurants')}}?dinein=1">{{trans('lang.dine_in_restaurants')}}</a>
