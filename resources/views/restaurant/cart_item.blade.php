				...
				<div class="bg-white p-3 clearfix btm-total">
					...
					<?php if($item_count && $total_price && @$cart['deliverycharge']){ ?>
						...
						<p class="mb-2">
							...
							{{trans('lang.deliveryCharge')}} <span class="float-right text-dark"><span class="currency-symbol-left"></span><?php echo @$cart['deliverycharge']; ?><span class="currency-symbol-right"></span> </span>
					...
					<?php if($item_count && $total_price && @$cart['tax_label'] && @$cart['tax']){ ?>
						...
						<p class="mb-2">
							 ...
							 <?php echo $cart['tax_label']; ?><span class="float-right text-dark"><span class="currency-symbol-left"></span><?php echo @$cart['tax']; ?><span class="currency-symbol-right"></span> </span>
