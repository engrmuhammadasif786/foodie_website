	...
	<!-- 	<div class="pb-4">
			...
			<div class="row">
				...
				<div class="col-6 col-md-2">
					...
					<p class="text-white-50 font-weight-bold m-0 small">

						Open time

					</p>

					<p class="text-white m-0" id="vendor_open_time"></p>
				...
				if(deliveryChargemain.vendor_can_modify){
					if(vendorDetails.DeliveryCharge){
						if(vendorDetails.DeliveryCharge.delivery_charges_per_km && vendorDetails.DeliveryCharge.minimum_delivery_charges && vendorDetails.DeliveryCharge.minimum_delivery_charges_within_km){
							newdeliveryCharge=vendorDetails.DeliveryCharge;
						}
					}
				}
	...
	$( document ).ready(function() {
		...
		$(document).on("click", '.add-to-cart', function(event) { 
			...
			$.ajax({
               ...
               data:{_token:'<?php echo csrf_token(); ?>',restaurant_id:restaurant_id,extra:extra,size:size,id:id,quantity:quantity,name:name,price:price,image:image,extra_price:extra_price,item_price:item_price,restaurant_location:restaurant_location,restaurant_name:restaurant_name,restaurant_image:restaurant_image,deliveryCharge:deliveryCharge,delivery_option:delivery_option,veg:veg,iteam_extra_price:iteam_extra_price,taxValue:taxValue,restaurant_latitude:restaurant_latitude,restaurant_longitude:restaurant_longitude},
